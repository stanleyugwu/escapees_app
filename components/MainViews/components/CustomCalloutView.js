    ...
    <CalloutWrapper>
      <Callout>
            ...
            <Grid>
              <Col size={1}>
                <Thumbnail
                  ...
                  //   source={{
                  //     uri:
                  //       s.logoUrl || "https://cdn.mdshosted.com/app/default.png",
                  //   }}
                  source={require("../../../assets/images/station_default.png")}
                  onError={console.log}
                  onLoad={console.log}
          ...
          <MoreInfo>
            <AddressWrapper>
              <HighWay>
                ...
                <Text fontWeight="bold" fontSize={12} numberOfLines={2}>
                  {s.address1}
                </Text>
              </HighWay>
        ...
        <Col2>
          ...
          <MemberPrice>
            <Text color="#ddd" fontSize={10} fontWeight="bold">
              Your Price
            </Text>
            <View style={{ flexDirection: "row" }}>
              <View>
          ...
          <MoneySaved>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View>{savingChange ? <Sup>{savingChange}</Sup> : null}</View>
              <View>
