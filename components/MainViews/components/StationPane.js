        ...
        <Grid style={styles.PaneWrapper}>
                <Row>
                    <Col size={7} style={styles.FirstCol}>
                        <Row style={styles.LogoWrapper}>
                            ...
                            <Col size={6} style={{justifyContent:'center'}}>
                                <Text size={17} color="#444" style={{fontStyle:'italic'}}>{s.name + ', ' + s.state}</Text>
                            </Col>
                        </Row>{/* Logo and Station Name */}
                        ...
                        <Row style={{paddingTop:5}}>
                            ...
                            <Col style={{justifyContent:'center',paddingLeft:10}}>
                                <Text color="#888" size={13}>RV LANE</Text>
                                <Text color="#888" size={13}>DUMP STATION</Text>
                                <Text color="#888" size={13}>BIG RIG FRIENDLY</Text>
                                <Text color="#888" size={13}>PROPANE</Text>
                                <Text color="#888" size={13}>TRUCK WASH</Text>
                            </Col>{/* Services */}
                    ...
                    <Col size={2} style={{paddingLeft:10}}>
                        <Row>
                            <Center>
                                <Text weight={600} size={12}>Retail Price</Text>
                                <Row>
                                    <Text style={styles.Money} weight={500}>${regularPriceWhole}</Text>
                                    {
                        ...
                        <Row>
                            <Center style={{...styles.YourPrice,marginVertical:5,}}>
                                <Row>
                                    <Text weight={500} color="#fff" size={12}>Your Price</Text>
                                </Row>
                                <Row>
                                    <Text color="#fff" style={styles.Money}>${memberPriceWhole}</Text>
                                    {
                        ...
                        <Row>
                            <Center>
                                <Text weight={700} size={12} color="#777">You Save</Text>
                                <Row>
                ...
                <Row style={{marginTop:7}}>
                    ...
                    <Col size={2} style={{justifyContent:'center'}}>
                        <Row>
                            <Icon name="phone" style={{fontSize:16,color:'#555'}} type="FontAwesome5"/>
                            <Text style={{textAlignVertical:'center',paddingLeft:5}} size={13}>{s.contact || "469-941-3150"}</Text>
                        </Row>
                    </Col>
                    {/* Contact */}
                    ...
                    <Col size={1}>
                        ...
                        <Icon name="star" style={{fontSize:20,color:'white',position:'absolute',bottom:-3,right:-3}} />
                    </Col>
                    {/* Favourite */}
...
const styles = StyleSheet.create({
    ...
    YourPrice:{backgroundColor:'#090',borderRadius:10,padding:3,alignItems:'center',justifyContent:'center'},
    Money:{
        fontSize:17
    },
    TriangleCorner:{
