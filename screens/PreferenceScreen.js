...
import { Root, Container, Content, Icon, Grid, Col, Row, Text, Badge} from 'native-base';
...
const PreferencesScreen = (props) => {
    ...
    const [fuelUnitPreference, setFuelUnitPreference] = useState('pricePerGallon');
    ...
    //exit screen
    const _exitScreen = () => {
        let saved = _savePreferences();
        if(!saved) Alert.alert('Preferences Not Saved',`Your preferences couldn't be stored`);
                ...
                <Content contentContainerStyle={{flex:1,}}>
                    <Grid>
                        ...
                        >
                            ...
                            >
                                <Icon name="star"/>
                                <Text style={{fontWeight:'bold',marginLeft:10}}>Preferences</Text>
                            </Col>
                                ...
                                <Row size={2}>
                                    ...
                                    <Col style={styles.center}>
                                        ...
                                        <Row>
                                            ...
                                            >
                                                <RadioButton
                                                    checked={fuelTypePreference == 'diesel'}
                                                />
                                            </TouchableOpacity>
                                        </Row>
                                    </Col>
                                    ...
                                    <Col style={styles.center}>
                                        ...
                                        <Row style={{alignSelf:'flex-start'}}>
                                            <Badge style={[
                                                ...
                                                <Text style={[styles.badgeText,{fontWeight:'200'}]}>Gas</Text>
                                            </Badge>
                                            <Badge success style={[
                                                styles.badge,
                                                {
                            ...
                            <Grid>
                                <Row size={1} style={{flexDirection:'column'}}>
                                    ...
                                    <Text style={{
                                        ...
                                        The price displayed in the app will be based on your fuel preference below.
                                    </Text>
                                </Row>
                                ...
                                <Row size={2}>
                                    ...
                                    <Col style={styles.center}>
                                        <Row style={{alignItems:'flex-end',flexDirection:'column'}}>
                                            <Text style={[styles.optionText,{fontStyle:'italic',fontWeight:'bold'}]}>
                                                Gasoline
                                            </Text>
